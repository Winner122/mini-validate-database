;; data-validator.clar
;; Mini Database Validation Contract
;; This contract provides a secure and flexible system for tracking, validating, 
;; and managing digital records on the Stacks blockchain. It enables users to 
;; create, update, and monitor data entries with robust access control and 
